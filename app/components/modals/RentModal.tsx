...
const RentModal = () => {
   ...
   /* re-render everytime locaiton changes */
   const Map = useMemo(
      ...
      bodyContent = (
         <div className="flex flex-col gap-8">
            ...
            <CountrySelect
               value={location}
               onChange={(value) => {
                  setCustomeValue('location', value);
               }}
            />
   ...
   if (step === STEPS.INFO) {
      bodyContent = (
         <div className="flex flex-col gap-8">
            ...
            <Counter
               title="Guest"
               subtitle="How manay guests do you allow?"
               value={guestCount}
            ...
            <Counter
               title="Rooms"
               subtitle="How manay rooms do you have?"
               value={roomCount}
            ...
            <Counter
               title="Bathrooms"
               subtitle="How manay bathrooms do you have?"
               value={bathroomCount}
